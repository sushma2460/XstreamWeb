  ...
  return (
    <div className="privacy-container">
      ...
      <ul>
        ...
        <li>Phone number</li>
        <li>Company name</li>
        <li>Any other information you provide directly to us via forms of communication channels.</li>
      </ul>
      ...
      <h3><b>3. How We Share Your Information</b></h3>
      ...
      <ul>
        <li>
          <b>With Service Providers:</b> We may share information with third-party vendors or service providers who help us operate the Website or provide services to you.
        </li>
        <li>
          <b>For Legal Reasons:</b> We may disclose information to comply with legal obligations or to protect our rights and interests.
        </li>
        <li>
          <b>In Business Transfers:</b> If we are involved in a merger, acquisition, or sale of assets, your information may be transferred.
        </li>
      </ul>

      <h3><b>4. Cookies and Tracking Technologies</b></h3>
      <p className='privacy-p'>
      ...
      <p className='privacy-p'>
        You can manage your cookie preferences through your browser settings. However, disabling cookies may limit some functionalities of the Website.
      </p>

      <h3><b>5. Data Security</b></h3>
      <p className='privacy-p'>
        We implement reasonable technical and organizational measures to safeguard your personal information against unauthorized access, alteration, disclosure, or destruction. However, no system can guarantee absolute security.
      </p>

      <h3><b>6. Third-Party Links</b></h3>
      <p className='privacy-p'>
      ...
      <h3><b>7. Your Privacy Rights</b></h3>
      <p className='privacy-p'>
        Depending on your location, you may have certain rights under applicable data protection laws, such as:
      </p>
      <ul>
      ...
      <h3><b>8. Children's Privacy</b></h3>
      <p className='privacy-p'>
        Our Website is not intended for individuals under the age of 13. We do not knowingly collect personal information from children. If we discover that we have collected information from a child, we will delete it promptly.
      </p>

      <h3><b>9. Changes to This Privacy Policy</b></h3>
      <p className='privacy-p'>
        We may update this Privacy Policy from time to time. Any changes will be reflected on this page with a revised "Effective Date." Your continued use of the Website after such changes signifies your acceptance of the updated policy.
      </p>
      ...
      <p className='privacy-p'>
        <b>Email:</b> <a href="mailto:info@xstreaminds.com">info@xstreaminds.com</a>
      </p>
      <p>Thank you for trusting Xstream Minds Private Limited</p>
    </div>
